...
module Snakes
  module DefaultBoards
    ...
    # While it's possible to setup a custom board, chances are that most users
    # care about doing so. This class represents a predefined standard game
    # board for ease of setup.
    class Standard10x10
      class << self
        def new
